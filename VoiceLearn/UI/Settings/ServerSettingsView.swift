// VoiceLearn - Server Settings View
    ...
    public var body: some View {
        List {
            ...
            Section {
                ...
                Text("Run 'server/setup.sh' on your Mac to set up the VoiceLearn server stack.")
            }
...
struct AddServerSheet: View {
    ...
    @State private var serverType: ServerType = .voicelearnGateway
    @State private var isTesting = false
